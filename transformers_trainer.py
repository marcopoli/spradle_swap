...
def main():
    #!WARNING! train, dev and trest file should not end with a white space.
    #bert-base-uncased
    #bert-base-multilingual-uncased
    #dccuchile/bert-base-spanish-wwm-cased - BETO
    #roberta-base
    #xlm-roberta-base
    #skimai/electra-small-spanish - ELECTRA ES
    #google/electra-base-discriminator - ELECTRA EN
    #kamalkraj/bioelectra-base-discriminator-pubmed - ELECTRA MED
    #alvaroalon2/biobert_diseases_ner
    parser = argparse.ArgumentParser(description="BERT CRF implementation",)
    opt = parse_arguments(parser)
    opt.model_folder ="ele"
    opt.mode ="train"
    opt.dataset="spradle"
    opt.embedder_type="kamalkraj/bioelectra-base-discriminator-pubmed"
    opt.batch_size=64
    opt.num_epochs=100
